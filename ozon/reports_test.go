		...
		// Test Ok
		{
			...
			&GetFinancialReportParams{
				Date: GetFinancialReportDatePeriod{
					From: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2022-01-01T00:00:00.000Z"),
					To:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2022-12-31T00:00:00.000Z"),
				},
				WithDetails: true,
				Page:        1,
				PageSize:    1,
		...
		// Test Ok
		{
			...
			&GetShipmentReportParams{
				Filter: &GetShipmentReportFilter{
					...
					ProcessedAtFrom: ozonCore.NewTimeFormat(ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-09-02T17:10:54.861Z"), "2006-01-02T15:04:05Z"),
					ProcessedAtTo:   ozonCore.NewTimeFormat(ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-02T17:10:54.861Z"), "2006-01-02T15:04:05Z"),
				},
			},
			`{
				"result": {
