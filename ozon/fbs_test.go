	...
	tests := []struct {
		...
		// Test Ok
		{
			...
			&CreateActParams{
				...
				DepartureDate:    ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2022-06-10T11:42:06.444Z"),
			},
			`{
				"result": {
				  "id": 5819327210249
		...
		// Test Ok
		{
			...
			&RescheduleShipmentDeliveryDateParams{
				...
				NewTimeslot: RescheduleShipmentDeliveryDateTimeslot{
					From: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2023-03-25T08:51:56.932Z"),
					To:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2023-03-25T08:51:56.932Z"),
				},
			},
			`{
				"result": true
	...
	tests := []struct {
		...
		// Test Ok
		{
			...
			&AvailableFreightsListParams{
				DeliveryMethodId: 0,
				DepartureDate:    ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
			},
			`{
				"result": [
				  {
		...
		// Test Ok
		{
			...
			&ETGBCustomsDeclarationsParams{
				Date: ETGBCustomsDeclarationsDate{
					From: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2023-02-13T12:13:16.818Z"),
					To:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2023-02-13T12:13:16.818Z"),
				},
			},
			`{
				"result": [
	...
	tests := []struct {
		...
		// Test Ok
		{
			...
			&SetShippingDateParams{
				NewCutoffDate: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
			},
			`{
				"result": true
			}`,
