		...
		// Test Ok
		{
			...
			&GetFBOShipmentsListParams{
				...
				Filter: GetFBOShipmentsListFilter{
					Since:  ozonCore.NewTimeFormat(ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-09-01T00:00:00.000Z"), "2006-01-02T15:04:05Z"),
					Status: "awaiting_packaging",
					To:     ozonCore.NewTimeFormat(ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-17T10:44:12.828Z"), "2006-01-02T15:04:05Z"),
				},
				Limit:    5,
				Offset:   0,
				Translit: true,
		...
		// Test Ok
		{
			...
			&UpdateSupplyTimeslotParams{
				...
				Timeslot: SupplyTimeslotValueTimeslot{
					From: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
					To:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
				},
			},
			`{
				"errors": [
		...
		// Test Ok
		{
			...
			&CreateSupplyFromDraftParams{
				...
				Timeslot: CreateSupplyFromDraftTimeslot{
					FromInTimezone: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
					ToInTimezone:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
				},
				WarehouseId: 45,
			},
			`{
	...
	tests := []struct {
		...
		// Test Ok
		{
			...
			&GetDraftTimeslotsParams{
				DraftId:      123,
				DateFrom:     ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
				DateTo:       ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
