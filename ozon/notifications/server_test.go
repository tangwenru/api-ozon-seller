...
func pingTest(t *testing.T) testData {
	return testData{
		object: &pingRequest{
			...
			Time:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2019-08-24T14:15:22Z"),
		},
		raw: `{
...
func newPostingTest(t *testing.T) testData {
	return testData{
		object: &NewPosting{
			...
			InProccessAt: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-01-26T06:56:36.294Z"),
...
func postingCancelledTest(t *testing.T) testData {
	return testData{
		object: &PostingCancelled{
			...
			ChangedStateDate: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-01-26T06:56:36.294Z"),
...
func cutoffDateChangedTest(t *testing.T) testData {
	return testData{
		object: &CutoffDateChanged{
			...
			NewCutoffDate: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-24T07:00:00Z"),
			OldCutoffDate: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-21T10:00:00Z"),
			WarehouseId:   1,
			SellerId:      15,
		},
		raw: `{
...
func deliveryDateChangedTest(t *testing.T) testData {
	return testData{
		object: &DeliveryDateChanged{
			...
			PostingNumber:        "24219509-0020-2",
			NewDeliveryDateBegin: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-24T07:00:00Z"),
			NewDeliveryDateEnd:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-24T16:00:00Z"),
			OldDeliveryDateBegin: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-21T10:00:00Z"),
			OldDeliveryDateEnd:   ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-11-21T19:00:00Z"),
			WarehouseId:          1,
			SellerId:             15,
		},
		raw: `{
...
func priceIndexChangedTest(t *testing.T) testData {
	return testData{
		object: &PriceIndexChanged{
			...
			UpdatedAt:  ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2022-06-21T05:52:46.648533678Z"),
			SKU:        147451959,
			ProductId:  1234,
			PriceIndex: 5678,
			SellerId:   15,
...
func stocksChangedTest(t *testing.T) testData {
	return testData{
		object: &StocksChanged{
			...
			Items: []Item{
				{
					UpdatedAt: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-09-01T14:15:22Z"),
					SKU:       5678,
					ProductId: 1234,
					Stocks: []Stock{
						{
...
func newMessageTest(t *testing.T) testData {
	return testData{
		object: &NewMessage{
			...
			CreatedAt: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2022-07-18T20:58:04.528Z"),
...
func updateMessageTest(t *testing.T) testData {
	return testData{
		object: &UpdateMessage{
			...
			UpdatedAt: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2022-07-18T20:59:04.528Z"),
		},
		raw: `{  
...
func createUpdateItemTest(t *testing.T) testData {
	return testData{
		object: &CreateOrUpdateItem{
			...
			ProductId: 5678,
			IsError:   false,
			ChangedAt: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2022-09-01T14:15:22Z"),
			SellerId:  15,
		},
		raw: `{
...
func stateChangedTest(t *testing.T) testData {
	return testData{
		object: &StateChanged{
			...
			ChangedStateDate: ozonCore.TimeFromString(t, "2006-01-02T15:04:05Z", "2021-02-02T15:07:46.765Z"),
			WarehouseId:      1,
			SellerId:         15,
		},
		raw: `{
